...
require("prototypes.BioTechExtended.entities")
require("prototypes.BioTechExtended.items")
require("prototypes.BioTechExtended.recipes")
require("prototypes.BioTechExtended.technology")
